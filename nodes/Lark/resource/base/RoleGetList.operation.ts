...
export default {
	...
	options: [
		...
		{
			displayName: `<a target="_blank" href="https://open.larksuite.com/document/docs/bitable-v1/advanced-permission/app-role/list-2">${WORDING.OpenDocument}</a>`,
			name: 'notice',
			type: 'notice',
			default: '',
		},
	...
	async call(this: IExecuteFunctions, index: number): Promise<IDataObject[]> {
		...
		const list = (allRoles ?? []) as IDataObject[];
