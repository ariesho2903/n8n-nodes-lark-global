...
export default {
	...
	options: [
		...
		{
			displayName: `<a target="_blank" href="https://open.larksuite.com/document/server-docs/docs/bitable-v1/app-table/list">${WORDING.OpenDocument}</a>`,
			name: 'notice',
			type: 'notice',
			default: '',
		},
	...
	async call(this: IExecuteFunctions, index: number): Promise<IDataObject[]> {
		...
		const list = (allTables ?? []) as IDataObject[];
