...
export default {
	...
	options: [
		{
			displayName: `Only work with <a target="_blank" href="https://open.larksuite.com/document/server-docs/authentication-management/access-token/tenant_access_token_internal">Tenant Token.</a>`,
			name: 'notice',
			type: 'notice',
			default: '',
		},
