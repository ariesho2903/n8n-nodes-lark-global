	...
	options: [
		{
			...
			required: true,
			description:
				'Used to encrypt the transmission. <a target="_blank" href="https://open.larksuite.com/document/event-subscription-guide/event-subscriptions/event-subscription-configure-/choose-a-subscription-mode/send-notifications-to-developers-server#e0dff53d">Check Doc</a>.',
			typeOptions: {
				password: true,
			},
			default: '',
		},
		{
			...
			required: true,
			description:
				'Used for the application verification identifier. <a target="_blank" href="https://open.larksuite.com/document/event-subscription-guide/event-subscriptions/event-subscription-configure-/choose-a-subscription-mode/send-notifications-to-developers-server#c589dfb1">Check Doc</a>.',
			typeOptions: {
				password: true,
			},
			default: '',
		...
		{
			displayName: `<a target="_blank" href="https://open.larksuite.com/document/event-subscription-guide/event-subscriptions/event-subscription-configure-/choose-a-subscription-mode/send-notifications-to-developers-server">${WORDING.OpenDocument}</a>`,
			name: 'notice',
			type: 'notice',
			default: '',
		},
